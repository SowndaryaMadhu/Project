...
//	    @PostMapping("/user/{email}/image")
//	    public ResponseEntity<Post> createPost(@RequestBody Post post, @PathVariable String email, @RequestParam("file") MultipartFile file) {
//	        try {
//	            // Extract image bytes
//	            byte[] imageBytes = file.getBytes();
//	            
...
//	            service.updateImageBytes(createdPost.getId(), imageBytes);
//	            
